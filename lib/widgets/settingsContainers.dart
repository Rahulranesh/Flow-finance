  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: OpenContainerNavigation(
        ...
        onOpen: onOpen,
        closedColor:
            backgroundColor ?? getCupertinoSurfaceColor(context, level: 0.6),
...
class SettingsContainerOutlined extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (isOutlinedColumn == true) {
      content = Container(
        decoration: getCupertinoCardDecoration(
          context,
          radius: 24,
          color: getCupertinoSurfaceColor(context, level: 0.8),
        ),
        padding: EdgeInsetsDirectional.only(
          start: horizontalPadding ?? 10,
          end: horizontalPadding ?? 10,
          top: verticalPadding ?? 18,
          bottom: verticalPadding ?? 18,
        ),
        child: Column(
          ...
          children: [
            icon == null
                ...
                : Container(
                    ...
                    child: Transform.scale(
                      ...
                      child: Icon(
                        icon,
                        size: iconSize ?? defaultIconSize + 3,
            ...
            TextFont(
              text: title,
              fontSize: 13.5,
              textColor: getCupertinoPrimaryTextColor(context),
              maxLines: 2,
              autoSizeText: true,
                ...
                : Padding(
                    ...
                    child: Container(
                      ...
                      child: Transform.scale(
                        ...
                        child: Icon(
                          icon,
                          size: iconSize ?? defaultIconSize - 1,
                          color: Theme.of(context).colorScheme.primary,
                        ),
                      ),
                    ),
              ...
              child: Container(
                decoration: BoxDecoration(
                  color: backgroundColor ??
                      getCupertinoSurfaceColor(context, level: 0.5),
                  border: Border.all(
                    color: getCupertinoBorderColor(context, opacity: 0.8),
                    width: 0.8,
                  ),
                  borderRadius: BorderRadiusDirectional.circular(
                    (enableBorderRadius || getIsFullScreen(context)) ? 22 : 18,
                  ),
                  boxShadow: getCupertinoShadow(context, elevation: 0.6),
                ),
                child: Padding(
                                            ...
                                            child: AnimatedSizeSwitcher(
                                              child: TextFont(
                                                ...
                                                textColor: descriptionColor ??
                                                    getCupertinoSecondaryTextColor(
                                                        context),
                                              ),
                                            ),
                                          ),
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: TextFont(
        ...
        fontSize: 15,
        fontWeight: FontWeight.bold,
        textColor: getCupertinoSecondaryTextColor(context),
      ),
    );
  }
}
