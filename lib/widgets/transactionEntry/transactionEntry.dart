          ...
          child: ValueListenableBuilder(
            ...
            builder: (context, _, __) {
              ...
              bool isTransactionAfterSelected = transactionAfter != null &&
                  globalSelectedID.value[listID ?? "0"]!
                      .contains(transactionAfter?.transactionPk);
              double borderRadius = getPlatform() == PlatformOS.isIOS ? 18 : 22;
              return ValueListenableBuilder(
                valueListenable: recentlyAddedTransactionInfo,
                builder: (context, _, __) {
                  Color selectedColor = categoryTintColor == null
                      ? getCupertinoTintedSurfaceColor(
                          context,
                          Theme.of(context).colorScheme.primary,
                          amount: 0.14,
                        )
                      : categoryTintColor!.withOpacity(
                  ...
                  Widget transactionEntryWidget = Padding(
                    ...
                    child: OpenContainerNavigation(
                      ...
                      closedColor: containerColor ??
                          getCupertinoSurfaceColor(context, level: 0.55),
                                ...
                                border: Border.all(
                                  color: selected
                                      ? Theme.of(context)
                                          ...
                                          .primary
                                          .withOpacity(0.16)
                                      : getCupertinoBorderColor(
                                          context,
                                          opacity: 0.82,
                                        ),
                                  width: 0.8,
                                ),
                                boxShadow: isTransactionBeforeSelected ||
                                        isTransactionAfterSelected
                                    ? const []
                                    : getCupertinoShadow(
                                        context,
                                        elevation: selected ? 0.9 : 0.45,
                                      ),
