  ...
  Widget build(BuildContext context) {
    return Container(
      padding: EdgeInsetsDirectional.only(
        start: widget.compact ? 13 : 16,
        end: widget.compact ? 4 : 8,
        top: widget.compact ? 4 : 10,
        bottom: widget.compact ? 4 : 10,
      ),
      decoration: getCupertinoCardDecoration(
        context,
        radius: widget.compact ? 16 : 20,
        color: widget.backgroundColor ?? getCupertinoSurfaceColor(context),
      ),
      child: DropdownButton<String>(
        ...
        icon: Icon(
          ...
          color: getCupertinoSecondaryTextColor(context),
        ),
            ...
            onPressed: () {
              showCupertinoModalPopup<void>(
                ...
                builder: (BuildContext context) => CupertinoActionSheet(
                  actions: itemsFiltered.map((menuItem) {
