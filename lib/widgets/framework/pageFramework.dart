          ...
          child: Builder(builder: (context) {
            ...
            return Container(
              ...
              decoration: getCupertinoCardDecoration(
                context,
                radius: borderRadius,
                color: getCupertinoSurfaceColor(context, level: 1),
              ),
              child: Column(
                ...
                children: [
                        ...
                        child: Transform.rotate(
                          ...
                          child: Icon(
                            appStateSettings["outlinedIcons"]
                                ? CupertinoIcons.back
                                : CupertinoIcons.back,
                            color: getCupertinoPrimaryTextColor(context),
                  ...
                  SizedBox(
                    ...
                    child: Tappable(
                      ...
                      child: Padding(
                        padding: EdgeInsetsDirectional.only(bottom: iconInset),
                        child: Transform.rotate(
                          angle: directionalityReverse(context) * -pi / 2,
                          child: Icon(
                            appStateSettings["outlinedIcons"]
  ...
  return [
    Container(
      decoration: BoxDecoration(
        gradient: getCupertinoBackgroundGradient(context),
      ),
                  ...
                  child: Container(
                    ...
                    color:
                        forceBackgroundColors || appBarBackgroundColor == null
                            ? getCupertinoSurfaceColor(context, level: 0.3)
                                .withOpacity(0.92)
                            : appBarBackgroundColor,
                  ),
                ),
              ...
              Widget container = ClipRect(
                child: BackdropFilter(
                  ...
                  child: Container(
                    ...
                    width: MediaQuery.sizeOf(context).width,
                    height: MediaQuery.sizeOf(context).height - 1,
                    color: appBarBGColorCalculated.withOpacity(0.88),
                  ),
                ),
              );
              return forceBackgroundColors
...
class PageFrameworkBackground extends StatelessWidget {
  const PageFrameworkBackground({super.key});
